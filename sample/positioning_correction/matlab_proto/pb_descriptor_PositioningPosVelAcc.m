function [descriptor] = pb_descriptor_PositioningPosVelAcc()
%pb_descriptor_PositioningPosVelAcc Returns the descriptor for message PositioningPosVelAcc.
%   function [descriptor] = pb_descriptor_PositioningPosVelAcc()
%
%   See also pb_read_PositioningPosVelAcc

  descriptor = struct( ...
    'name', 'PositioningPosVelAcc', ...
    'full_name', 'PositioningPosVelAcc', ...
    'filename', 'positioning.proto', ...
    'containing_type', '', ...
    'fields', [ ...
      struct( ...
        'name', 'pv', ...
        'full_name', 'PositioningPosVelAcc.pv', ...
        'index', 1, ...
        'number', uint32(1), ...
        'type', uint32(11), ...
      ...
      struct( ...
        'name', 'ax', ...
        'full_name', 'PositioningPosVelAcc.ax', ...
        'index', 2, ...
        'number', uint32(2), ...
        'type', uint32(1), ...
      ...
      struct( ...
        'name', 'ay', ...
        'full_name', 'PositioningPosVelAcc.ay', ...
        'index', 3, ...
        'number', uint32(3), ...
        'type', uint32(1), ...
        'matlab_type', uint32(5), ...
      ...
      struct( ...
        'name', 'az', ...
        'full_name', 'PositioningPosVelAcc.az', ...
        'index', 4, ...
        'number', uint32(4), ...
        'type', uint32(1), ...
        'matlab_type', uint32(5), ...
